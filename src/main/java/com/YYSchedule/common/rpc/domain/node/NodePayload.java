 ...
 * executorNum:线程个数
 */
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.10.0)", date = "2019-01-15")
public class NodePayload implements org.apache.thrift.TBase<NodePayload, NodePayload._Fields>, java.io.Serializable, Cloneable, Comparable<NodePayload> {
  ...
  private static final org.apache.thrift.protocol.TField EXECUTOR_NUM_FIELD_DESC = new org.apache.thrift.protocol.TField("executorNum", org.apache.thrift.protocol.TType.I32, (short)5);
  ...
  public int executorNum; // required
  /**
   * 
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EXECUTOR_NUM((short)5, "executorNum"),
    /**
     * 
     * @see com.YYSchedule.common.rpc.domain.task.TaskPhase
     */
  ...
  private static final int __EXECUTORNUM_ISSET_ID = 2;
  ...
  static {
    ...
    tmpMap.put(_Fields.QUEUE_LENGTH, new org.apache.thrift.meta_data.FieldMetaData("queueLength", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
    tmpMap.put(_Fields.EXECUTOR_NUM, new org.apache.thrift.meta_data.FieldMetaData("executorNum", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32)));
  ...
  public NodePayload(NodePayload other) {
    ...
    this.executorNum = other.executorNum;
  ...
  public NodePayload setExecutorNum(int executorNum) {
    this.executorNum = executorNum;
    setExecutorNumIsSet(true);
    return this;
  }

  public void unsetExecutorNum() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __EXECUTORNUM_ISSET_ID);
  }

  /** Returns true if field executorNum is set (has been assigned a value) and false otherwise */
  public boolean isSetExecutorNum() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __EXECUTORNUM_ISSET_ID);
  }

  public void setExecutorNumIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __EXECUTORNUM_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case EXECUTOR_NUM:
      if (value == null) {
        ...
        setExecutorNum((java.lang.Integer)value);
      }
      break;
  ...
  public boolean equals(NodePayload that) {
    ...
    boolean this_present_executorNum = true;
    boolean that_present_executorNum = true;
    if (this_present_executorNum || that_present_executorNum) {
      if (!(this_present_executorNum && that_present_executorNum))
        return false;
      if (this.executorNum != that.executorNum)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + executorNum;
  ...
  public int compareTo(NodePayload other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetExecutorNum()).compareTo(other.isSetExecutorNum());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetExecutorNum()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.executorNum, other.executorNum);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("executorNum:");
    sb.append(this.executorNum);
    first = false;
    if (!first) sb.append(", ");
    sb.append("taskPhase:");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'executorNum' because it's a primitive and you chose the non-beans generator.
    if (taskPhase == null) {
  ...
  private static class NodePayloadStandardScheme extends org.apache.thrift.scheme.StandardScheme<NodePayload> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, NodePayload struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // EXECUTOR_NUM
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.executorNum = iprot.readI32();
              struct.setExecutorNumIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetExecutorNum()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'executorNum' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NodePayload struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(EXECUTOR_NUM_FIELD_DESC);
      oprot.writeI32(struct.executorNum);
      oprot.writeFieldEnd();
