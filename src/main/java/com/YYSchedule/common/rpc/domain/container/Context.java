...
public class Context implements org.apache.thrift.TBase<Context, Context._Fields>, java.io.Serializable, Cloneable, Comparable<Context> {
  ...
  /**
   * 
   * @see com.YYSchedule.common.rpc.domain.job.JobPriority
   */
  public com.YYSchedule.common.rpc.domain.job.JobPriority priority; // required
  /**
   * 
  ...
  public com.YYSchedule.common.rpc.domain.parameter.JobParameter parameter; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PRIORITY, new org.apache.thrift.meta_data.FieldMetaData("priority", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, com.YYSchedule.common.rpc.domain.job.JobPriority.class)));
  ...
  public Context(
    long taskId,
    com.YYSchedule.common.rpc.domain.job.JobPriority priority,
  ...
  public Context(Context other) {
    ...
    if (other.isSetParameter()) {
      this.parameter = new com.YYSchedule.common.rpc.domain.parameter.JobParameter(other.parameter);
    }
   ...
   * @see com.YYSchedule.common.rpc.domain.job.JobPriority
   */
  public com.YYSchedule.common.rpc.domain.job.JobPriority getPriority() {
   ...
   * @see com.YYSchedule.common.rpc.domain.job.JobPriority
   */
  public Context setPriority(com.YYSchedule.common.rpc.domain.job.JobPriority priority) {
    this.priority = priority;
    return this;
  }
   ...
   * @see com.YYSchedule.common.rpc.domain.task.TaskPhase
   */
  public Context setTaskPhase(com.YYSchedule.common.rpc.domain.task.TaskPhase taskPhase) {
    this.taskPhase = taskPhase;
    return this;
  }
  ...
  public com.YYSchedule.common.rpc.domain.parameter.JobParameter getParameter() {
    return this.parameter;
  }

  public Context setParameter(com.YYSchedule.common.rpc.domain.parameter.JobParameter parameter) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case PRIORITY:
      if (value == null) {
        ...
        setPriority((com.YYSchedule.common.rpc.domain.job.JobPriority)value);
      }
      break;
    ...
    case PARAMETER:
      if (value == null) {
        ...
        setParameter((com.YYSchedule.common.rpc.domain.parameter.JobParameter)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // PRIORITY
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.priority = com.YYSchedule.common.rpc.domain.job.JobPriority.findByValue(iprot.readI32());
          ...
          case 15: // PARAMETER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.parameter = new com.YYSchedule.common.rpc.domain.parameter.JobParameter();
