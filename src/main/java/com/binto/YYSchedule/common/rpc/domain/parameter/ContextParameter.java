...
public class ContextParameter implements org.apache.thrift.TBase<ContextParameter, ContextParameter._Fields>, java.io.Serializable, Cloneable, Comparable<ContextParameter> {
  ...
  public void unsetNeedDownload() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __NEEDDOWNLOAD_ISSET_ID);
  }

  /** Returns true if field needDownload is set (has been assigned a value) and false otherwise */
  public boolean isSetNeedDownload() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __NEEDDOWNLOAD_ISSET_ID);
  }

  public void setNeedDownloadIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __NEEDDOWNLOAD_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case NEED_DOWNLOAD:
      if (value == null) {
        ...
        setNeedDownload((java.lang.Boolean)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((needDownload) ? 131071 : 524287);
  ...
  public int compareTo(ContextParameter other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetNeedDownload()).compareTo(other.isSetNeedDownload());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNeedDownload()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.needDownload, other.needDownload);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
